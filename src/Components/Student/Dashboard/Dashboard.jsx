...
function Dashboard() {
  return (
    <div>
      <Header />
      <div className='ltr'>
        <div className='ms-48 p-4'>รายการขอคำปรึกษา</div>
        <div className='ms-52 p-1'>
          <button type="button" className="text-black bg-[#D1E4FF] hover:bg-[#D1E4FF]/90 focus:ring-4 focus:ring-[#2557D6]/50 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#2557D6]/50 me-2 mb-2">
          ...
          <div className=''>
            <div class="relative overflow-x-auto">
              <table class="w-full text-sm text-left rtl:text-right text-black dark:text-black">
                <thead class="text-xs text-white uppercase bg-gray-50 dark:bg-[#091F59] dark:text-white-400">
                  <tr>
