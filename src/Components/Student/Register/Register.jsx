        ...
        <form>
          ...
          <div className='px-7 py-1'>
            <div className='flex justify-center flex-col space-y-4 mx-2'>
              <button onSubmit={handleSubmit} onClick={() => navigate("/")} type="button" class="text-white bg-[#091F59] hover:bg-[#091F59] focus:outline-none focus:ring-4 focus:ring-blue-300 font-bold rounded-full text-xs px-5 py-2.5 text-center  dark:bg-[#091F59] dark:hover:bg-blue-700 dark:focus:ring-blue-800">ลงทะเบียน</button>
            </div>
          </div>
        </form>
