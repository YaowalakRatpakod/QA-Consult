...
function Createreq() {
    ...
    return (
        <div>
            <Header />
            <div className='ltr'>
                <div className='ms-28 p-4  text-black'>รายการขอคำปรึกษา <img src={x} alt="" className='h-5 w-5 ' /></div>
            ...
            <div className='flex flex-col items-center justify-around'>
                ...
                <div className='mx-auto w-4/5 h-full '>
                    <div className='rounded-lg shadow-lg bg-white -mt-35 py-4 md:py30 px-4 md:px-5 '>
                        <div className="text-[#F2F0DE] w-1/2 bg-[#091F59] rounded-md focus:outline-none font-bold text-xs px-4 py-2.5">รายละเอียดการขอคำปรึกษา </div>
                    
                        <div className='px-4 py-2.5  text-black'>รายละเอียด</div>
                        <div className='bg-[#F2F0DE] rounded-md '>
