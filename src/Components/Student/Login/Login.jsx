            ...
            <div className='flex items-center justify-center'>
              <div className='font-regular text-sm text-[#091F59]'>รหัสผ่าน
                ...
                <div className='w-full text-right '>
                  <p onClick={() => navigate("/forget")} id="helper-text-explanation" class="text-sm text-gray-500 dark:text-gray-400"><a href="#" class="font-medium text-blue-600 hover:underline dark:text-blue-500">ลืมรหัสผ่าน</a>?</p>
                </div>
              </div>
            </div>
