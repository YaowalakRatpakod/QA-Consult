                ...
                <div className='mx-auto w-4/5 h-full  '>
                    <div className='rounded-lg shadow-lg border border-black bg-white -mt-35 pb-px pr-px md:py30  md:px-5 '>
                        ...
                        <div className='bg-orange-300 rounded-md mx-2 my-4 py-4 px-7'>
                            <div className='flex'>
                                <div className=''>
                                    <div className='text-black px-7 py-1 font-medium text-sm' name='name' >ชื่อ-นามสกุล : <span className='bg-white rounded-sm p-1'>{requestInfo.user}</span></div>
                            ...
                            "th-TH"
                                ...
                                <div className=''>
                                    <div className='text-black px-7 py-1 font-medium text-sm' name='name' >เลขที่คำร้อง : <span className='bg-white rounded-sm p-1'>{requestInfo.id}</span></div>
                                </div>
                            </div>
                                    ...
                                    <div class="flex items-start gap-2.5">
                                        <div class="flex flex-col w-full leading-1.5 bg-white  h-32 mr-10 rounded-md px-1 py-1">
                                            ...
                                            <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                ...
                                                <span class="text-sm font-normal text-gray-900 dark:text-white">เดี๋ยวลองทำตามดูสักครู่นะคะ</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
