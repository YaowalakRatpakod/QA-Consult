            ...
            >
              ...
              >
                <a href="#" className="py-2">
                  <img className="w-20 h-20 " src={proflie2} alt="" />
                </a>
                <a href="#" className="text-gray-700 block text-sm py-2">
                {userInfo.full_name}
                </a>

                <button
                  onClick={() => navigate("/loginOF")}
                  class="text-gray-700 rounded-full shadow-lg bg-red-200  text-center text-sm px-3 py-2 "
                >
                  ออกจากระบบ
                </button>
              </div>
